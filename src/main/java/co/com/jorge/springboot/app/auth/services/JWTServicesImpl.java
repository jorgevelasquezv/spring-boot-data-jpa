...
import co.com.jorge.springboot.app.auth.SimpleGrantedAuthorityMixin;
...
public class JWTServicesImpl implements IJWTService {
    ...
    public final static String SECRET = Base64Utils.encodeToString("Un4.Cl4v3.S3cr3t4".getBytes());
